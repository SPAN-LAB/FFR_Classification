...
from ...core.utils.function_detail import ArgumentDetail
...
class ModelInterface:
    ...
    @classmethod
    def get_training_options_details(cls) -> list[ArgumentDetail]:
        """
        Returns a list of ArgumentDetail objects describing the parameters
        expected in the training_options dictionary.
        """
        return [
            ArgumentDetail("num_epochs", int, NUM_EPOCHS, "Number of training epochs"),
            ArgumentDetail("batch_size", int, BATCH_SIZE, "Number of trials per batch"),
            ArgumentDetail("learning_rate", float, LEARNING_RATE, "Optimizer learning rate"),
            ArgumentDetail("weight_decay", float, WEIGHT_DECAY, "L2 regularization penalty"),
        ]
