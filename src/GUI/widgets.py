    ...
    def _refresh_training_options(self, model_name: str, current_val: dict):
        ...
        if model_name_lower == "jason_cnn":
            ...
            ads = [
                ...
                ArgumentDetail("embed_dim", int, 64, "Branch embedding dimension"),
            ]
        elif model_name_lower == "autoencoder":
            ads = [
                ArgumentDetail("latent_dim", int, 128, "Autoencoder latent dimension"),
