...
Taken together, the pipeline enables rapid experimentation. Load subjects once, compose preprocessing steps via method chaining or GUI actions, visualize intermediate states, and feed the exact same subject objects into the training loop—no glue code required.
